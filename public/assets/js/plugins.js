    ...
    function u(i) {
        ...
        if (i.parents(".dtr-animated-headline").hasClass("type")) {
            ...
            i.parents(".dtr-animated-headline").hasClass("clip")
                ? i.parents(".dtr-words-wrapper").animate({ width: "2px" }, c, function () {
                      w(i, e), f(e);
                  })
    ...
    function f(s, i) {
        s.parents(".dtr-animated-headline").hasClass("type")
            ...
            : s.parents(".dtr-animated-headline").hasClass("clip") &&
              s.parents(".dtr-words-wrapper").animate({ width: s.width() + 10 }, c, function () {
                  setTimeout(function () {
                      u(s);
                  }, p);
              });
    ...
    ((e = (function () {
        ...
        return function (t, o) {
            ...
            (n.defaults = {
                ...
                arrows: !0,
                asNavFor: null,
                prevArrow: '<a class="maf" href="#"><i class="fas fa-arrow-left"></i></a>',
                nextArrow: '<a class="maf" href="#"><i class="fas fa-arrow-right"></i></a>',
                autoplay: !1,
                autoplaySpeed: 3e3,
                centerMode: !1,
                centerPadding: "50px",
    ...
    (e.fn.attr2 = function () {
        ...
        (e.fn.ajaxSubmit = function (a) {
            ...
            "function" == typeof a ? (a = { success: a }) : void 0 === a && (a = {}),
                ...
                (a = e.extend(!0, { url: s, success: e.ajaxSettings.success, type: n || e.ajaxSettings.type, iframeSrc: /^https/i.test(window.location.href || "") ? "javascript:false" : "about:blank" }, a));
            var c = {};
                ...
                : (w =
                      (b || T) && j
                          ? (function (t) {
                                ...
                                a.data = null;
                                var s = e.extend(!0, {}, e.ajaxSettings, a, { contentType: !1, processData: !1, cache: !1, type: n || "POST" });
                                a.uploadProgress &&
                                    (s.xhr = function () {
            ...
            function k(t) {
                ...
                if (
                    ...
                    c.iframeTarget
                        ? (g = (p = e(c.iframeTarget)).attr2("name"))
                            ? (f = g)
                            : p.attr2("name", f)
                        : (p = e('<iframe name="' + f + '" src="' + c.iframeSrc + '" />')).css({ position: "absolute", top: "-1000px", left: "-1000px" }),
                    (d = p[0]),
                    (h = {
                        aborted: 0,
                        responseText: null,
                ...
                function A() {
                    ...
                    y.setAttribute("target", f),
                        ...
                        c.skipEncodingOverride || (n && !/post/i.test(n)) || u.attr({ encoding: "multipart/form-data", enctype: "multipart/form-data" }),
                        c.timeout &&
                        ...
                        if (c.extraData)
                            for (var s in c.extraData)
                                c.extraData.hasOwnProperty(s) &&
                                    (e.isPlainObject(c.extraData[s]) && c.extraData[s].hasOwnProperty("name") && c.extraData[s].hasOwnProperty("value")
                                        ? o.push(
                                              e('<input type="hidden" name="' + c.extraData[s].name + '">')
                    ...
                    if (!h.aborted && !M) {
                        ...
                        if ((E && E.location.href != c.iframeSrc) || x) {
                            ...
                            h.aborted && (i("upload aborted"), (a = null)),
                                ...
                                "success" === a
                                    ? (c.success && c.success.call(c.context, L, "success", h), T.resolve(h.responseText, "success", h), l && e.event.trigger("ajaxSuccess", [h, c]))
                                    : a && (void 0 === r && (r = h.statusText), c.error && c.error.call(c.context, h, a, r), T.reject(h, "error", r), l && e.event.trigger("ajaxError", [h, c, r])),
        ...
        (e.fn.ajaxForm = function (t) {
            ...
            return t.delegation
                ? (e(document).off("submit.form-plugin", this.selector, a).off("click.form-plugin", this.selector, n).on("submit.form-plugin", this.selector, t, a).on("click.form-plugin", this.selector, t, n), this)
                : this.ajaxFormUnbind().bind("submit.form-plugin", t, a).bind("click.form-plugin", t, n);
        }),
        ...
        (e.fn.formToArray = function (r, a) {
            ...
            for (o = 0, f = h.length; o < f; o++)
                if ((u = (l = h[o]).name) && !l.disabled)
                    if (r && p.clk && "image" == l.type) p.clk == l && (n.push({ name: u, value: e(l).val(), type: l.type }), n.push({ name: u + ".x", value: p.clk_x }, { name: u + ".y", value: p.clk_y }));
                    else if ((c = e.fieldValue(l, !0)) && c.constructor == Array) for (a && a.push(l), s = 0, m = c.length; s < m; s++) n.push({ name: u, value: c[s] });
                    else if (t.fileapi && "file" == l.type) {
                        a && a.push(l);
                        var v = l.files;
                        if (v.length) for (s = 0; s < v.length; s++) n.push({ name: u, value: v[s], type: l.type });
                        else n.push({ name: u, value: "", type: l.type });
                    } else null != c && (a && a.push(l), n.push({ name: u, value: c, type: l.type, required: l.required }));
            if (!r && p.clk) {
                var g = e(p.clk),
                    x = g[0];
                (u = x.name) && !x.disabled && "image" == x.type && (n.push({ name: u, value: g.val() }), n.push({ name: u + ".x", value: p.clk_x }, { name: u + ".y", value: p.clk_y }));
            }
            return n;
        }),
...
!(function (e, t, n) {
    ...
    (m.prototype.init = function () {
        ...
        (i.btn = e(
            [
                "<" + h.parentTag + ' aria-haspopup="true" role="button" tabindex="0" class="' + s + "_btn " + s + '_collapsed">',
        ...
        (m.prototype._itemClick = function (e) {
            ...
            n ||
                ...
                (n.ul = e.next("ul")),
                (n.parent = e.parent()),
                n.parent.hasClass(s + "_parent-link") && ((n.parent = e.parent().parent()), (n.ul = e.parent().next("ul"))),
                e.data("menu", n)),
                n.parent.hasClass(s + "_collapsed")
                    ? (n.arrow.html(t.openedSymbol), n.parent.removeClass(s + "_collapsed"), n.parent.addClass(s + "_open"), n.parent.addClass(s + "_animating"), this._visibilityToggle(n.ul, n.parent, !0, e))
                    : (n.arrow.html(t.closedSymbol), n.parent.addClass(s + "_collapsed"), n.parent.removeClass(s + "_open"), n.parent.addClass(s + "_animating"), this._visibilityToggle(n.ul, n.parent, !0, e));
        }),
                ...
                this.each(function () {
                    ...
                    function $() {
                        (y = D.data("gall")),
                            ...
                            !0 === h ? a.show() : a.hide(),
                            "" !== x ? c.show() : c.hide(),
                            w.length || !0 === b ? (e(".vbox-next").css("display", "block"), (_ = !0)) : (e(".vbox-next").css("display", "none"), (_ = !1)),
                            k.index(D) > 0 || !0 === b ? (e(".vbox-prev").css("display", "block"), (B = !0)) : (e(".vbox-prev").css("display", "none"), (B = !1)),
                        ...
                        return (
                            ...
                            void d.animate({ opacity: 0 }, 500, function () {
                                g.css("background", f),
                                    ...
                                    "iframe" == e.data("vbtype") ? ae() : "inline" == e.data("vbtype") ? oe() : "ajax" == e.data("vbtype") ? ie() : "video" == e.data("vbtype") ? ce(s) : (d.html('<img src="' + l + '">'), te()),
                                    (D = e),
                                    $(),
                                    (p = !1),
                    ...
                    (A.VBclose = function () {
                        ...
                        D.on("click", function (u) {
                            ...
                            return (
                                ...
                                e(".vbox-num").css({ color: H.numerationColor, "background-color": H.numerationBackground }),
                                ...
                                g.animate({ opacity: 1 }, 250, function () {
                                    "iframe" == D.data("vbtype") ? ae() : "inline" == D.data("vbtype") ? oe() : "ajax" == D.data("vbtype") ? ie() : "video" == D.data("vbtype") ? ce(s) : (d.html('<img src="' + l + '">'), te()),
                    ...
                    function de() {
                        c.html(x),
                            d.find(">:first-child").addClass("vbox-figlio").css({ width: n, height: v, padding: o, background: i }),
                    ...
                    "ontouchstart" in window
                        ...
                        : (e(document).on("mousedown", L), e(document).on("mouseup", L), e(document).on("mouseout", L), e(document).on("mousemove", L)),
            ...
            (C.animateScroll = function (i, s, e) {
                ...
                if (u || t) {
                        ...
                        b = function (e, t) {
                            ...
                            if (e == t || r == t || (l < t && w.innerHeight + r) >= v)
                                return (
                                    ...
                                    a || (n.focus(), document.activeElement !== n && (n.setAttribute("tabindex", "-1"), n.focus(), (n.style.outline = "none")), w.scrollTo(0, o)),
                                    Q("scrollStop", c, i, s),
                                    !(A = d = null)
                                );
                        },
                    ...
                    0 === w.pageYOffset && w.scrollTo(0, 0),
                        (m = i),
                        (h = c),
                        u || (history.pushState && h.updateURL && history.pushState({ smoothScroll: JSON.stringify(h), anchor: m.id }, document.title, m === document.documentElement ? "#top" : "#" + m.id)),
                        "matchMedia" in w && w.matchMedia("(prefers-reduced-motion)").matches ? w.scrollTo(0, Math.floor(g)) : (Q("scrollStart", c, i, s), C.cancelScroll(!0), w.requestAnimationFrame(O));
                }
            });
        var t = function (e) {
                if (
                    ...
                    (n = n || "#top" !== t ? n : document.documentElement) &&
                        ...
                        (function (e) {
                            if (history.replaceState && e.updateURL && !history.state) {
                                ...
                                (t = t || ""), history.replaceState({ smoothScroll: JSON.stringify(e), anchor: t || w.pageYOffset }, document.title, t || w.location.href);
                            }
                        })(I),
                        C.animateScroll(n, a));
                }
...
!(function (e) {
    ...
    e.fn.parallaxie = function (t) {
        return (
            (t = e.extend({ speed: 0.2, repeat: "no-repeat", size: "cover", pos_x: "center", offset: 0 }, t)),
            this.each(function () {
                var a = e(this),
                    n = a.data("parallaxie");
                ...
                if (void 0 === s) {
                    ...
                    a.css({ "background-image": s, "background-size": n.size, "background-repeat": n.repeat, "background-attachment": "fixed", "background-position": n.pos_x + " " + i + "px" }),
                        o(a, n),
